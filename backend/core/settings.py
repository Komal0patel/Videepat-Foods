...
# Database
# Using SQLite for standard Django auth/admin (optional, can use MongoDB for everything but Django Admin needs SQL usually unless using Djongo)
DATABASES = {
    'default': {
...
MONGODB_DB = env('MONGODB_DB', default='food_delivery')
